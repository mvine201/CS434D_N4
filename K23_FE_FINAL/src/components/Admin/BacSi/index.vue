            <template>
                                ...
                                <div class="row mb-2 mt-2">
                                    <div class="col-lg-12">
                                        <div class="position-relative search-bar-box input-group" style="width: 100%;">
                                            <input id="inputTimBacSi" @keyup.enter="searchBacSi()"
                                                v-model="tim_kiem.noi_dung_tim" type="text" class="form-control search-control"
                                                placeholder="Tìm kiếm theo tên bác sĩ...">
                                            <span class="position-absolute top-50 search-show translate-middle-y"><i
                                                    class='bx bx-search'></i></span>
                                            <span class="position-absolute top-50 search-close translate-middle-y"><i
                                                    class='bx bx-x'></i></span>
                                            <button id="btnTimKiemBacSi" v-on:click="searchBacSi()" class="btn btn-primary">Tìm
                                                Kiếm</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        <tr v-for="(value, index) in list_bac_si" :key="index" class="align-middle">
                                            ...
                                            <td class="text-center" style="width: 200px;">
                                                <button class="btn btn-success me-1 w-100" v-if="value.tinh_trang == 1"
                                                    v-on:click="changeStatusBacSi(value)">Hoạt
                                                    Động</button>
                                                <button class="btn btn-danger me-1 w-100" v-else
                                                    v-on:click="changeStatusBacSi(value)">Tạm Tắt</button>
                                            </td>
                                            <td class="text-center" style="width: 300px;">
                                                <button class="btn btn-info me-1" v-on:click="Object.assign(view_bac_si, value)"
                                                    data-bs-toggle="modal" data-bs-target="#viewBacSiModal" title="Xem">
                                                    <i class="bx bx-show"></i>
                                                </button>
                                                <button class="btn btn-primary me-1" data-bs-toggle="modal"
                                                    data-bs-target="#capNhatKhachhangModal"
                                                    v-on:click="Object.assign(update_bac_si, value)" title="Cập Nhật">
                                                    <i class="bx bx-edit"></i>
                                                </button>
                                                <button class="btn btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#xoaKhachhangModal"
                                                    v-on:click="Object.assign(del_bac_si, value)" title="Xóa">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <label>Họ Tên</label>
                                        <input id="ho_ten" type="text" class="form-control" v-model="create_bac_si.ho_ten"
                                            required>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Email</label>
                                        <input id="email" type="email" class="form-control" v-model="create_bac_si.email"
                                            required>
                                    </div>

                                    <div class="col-md-6 mb-2">
                                        <label>Số Điện Thoại</label>
                                        <input id="so_dien_thoai" type="text" class="form-control"
                                            v-model="create_bac_si.so_dien_thoai" required>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Ngày sinh</label>
                                        <input id="ngay_sinh" type="date" class="form-control" v-model="create_bac_si.ngay_sinh"
                                            required>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Giới Tính</label>
                                        <select id="gioi_tinh" class="form-select" v-model.number="create_bac_si.gioi_tinh"
                                            required>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select id="id_phong_kham" class="form-select" v-model="create_bac_si.id_phong_kham">
                                            <option value="">-- Chọn phòng khám --</option>
                                            <option v-for="p in list_phong_kham" :key="p.id" :value="p.id">{{ p.ten_phong_kham
                                                }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select id="chuyen_khoa" class="form-select" multiple
                                            v-model="create_bac_si.chuyen_khoa">
                                            <option v-for="ck in list_chuyen_khoa" :key="ck.id" :value="ck.id">{{
                                                ck.ten_chuyen_khoa }}</option>
                                        </select>
                                        <small class="text-muted">Giữ phím Ctrl (Windows) hoặc Command (Mac) để chọn nhiều
                                            chuyên khoa</small>
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        <label>Chức Danh</label>
                                        <input id="chuc_danh" type="text" class="form-control"
                                            v-model="create_bac_si.chuc_danh">
                                    </div>
                                    <div class="col-md-3 mb-2">
                                        <label>Số Năm Kinh Nghiệm</label>
                                        <input id="so_nam_kinh_nghiem" type="number" class="form-control"
                                            v-model.number="create_bac_si.so_nam_kinh_nghiem">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Mô Tả</label>
                                        <textarea id="mo_ta" class="form-control" rows="3"
                                            v-model="create_bac_si.mo_ta"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Kinh Nghiệm Làm Việc</label>
                                        <textarea id="kinh_nghiem_lam_viec" class="form-control" rows="3"
                                            v-model="create_bac_si.kinh_nghiem_lam_viec"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Quá Trình Đào Tạo</label>
                                        <textarea id="qua_trinh_dao_tao" class="form-control" rows="3"
                                            v-model="create_bac_si.qua_trinh_dao_tao"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Chứng Chỉ</label>
                                        <textarea id="chung_chi" class="form-control" rows="3"
                                            v-model="create_bac_si.chung_chi"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Thành Tựu</label>
                                        <textarea id="thanh_tuu" class="form-control" rows="3"
                                            v-model="create_bac_si.thanh_tuu"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Thành Viên Tổ Chức</label>
                                        <textarea id="thanh_vien_to_chuc" class="form-control" rows="3"
                                            v-model="create_bac_si.thanh_vien_to_chuc"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Tình Trạng</label>
                                        <select id="tinh_trang" class="form-select" v-model.number="create_bac_si.tinh_trang">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input id="hinh_anh" type="text" class="form-control" v-model="create_bac_si.hinh_anh"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select class="form-select" v-model="update_bac_si.id_phong_kham" required>
                                            <option value="">-- Chọn phòng khám --</option>
                                            <option v-for="phongKham in list_phong_kham" :key="phongKham.id"
                                                :value="phongKham.id">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <input type="number" class="form-control"
                                            v-model.number="update_bac_si.so_nam_kinh_nghiem">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Mô Tả</label>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <textarea class="form-control" rows="3"
                                            v-model="update_bac_si.kinh_nghiem_lam_viec"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Quá Trình Đào Tạo</label>
                                        <textarea class="form-control" rows="3"
                                            v-model="update_bac_si.qua_trinh_dao_tao"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Chứng Chỉ</label>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <label>Thành Viên Tổ Chức</label>
                                        <textarea class="form-control" rows="3"
                                            v-model="update_bac_si.thanh_vien_to_chuc"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label>Tình Trạng</label>
                ...
                <div class="modal fade" id="xoaKhachhangModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                                ...
                                <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <div class="text-white">Bạn có chắc chắn xóa bác sĩ <b>{{ del_bac_si.ho_ten }}</b>
                                                này không!</div>
                                        </div>
                                    </div>
                                </div>
                ...
                <!-- Add View Modal -->
                <div class="modal fade" id="viewBacSiModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
