                        ...
                        <div class="row ">
                            <div class="col-lg-12 d-flex justify-content-between align-items-center my-3">
                                <div>
                                    ...
                                    <p class="text-muted fs-6 mb-0">Đội ngũ bác sĩ giàu kinh nghiệm, được đào tạo chuyên
                                        sâu
                                        tại các bệnh
                                        viện uy tín</p>
                                </div>
                                    ...
                                    <div class="card border-0 shadow-sm h-100 w-100 rounded-4 overflow-hidden bg-white"
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex justify-content-center gap-4 mb-3">
                                                ...
                                                <div class="text-center">
                                                    <div class="fw-bold text-dark">{{ value.kinh_nghiem_lam_viec }}
                                                    </div>
                                        ...
                                        <div class="card-footer bg-white border-top pt-3">
                                            <div class="d-grid gap-2">
                                                <router-link :to="`/bac-si/chi-tiet/${value.id}`"
